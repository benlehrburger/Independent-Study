...
from diffusers import DDPMPipeline, DDIMScheduler, StableDiffusionImg2ImgPipeline
...
start_model = "stabilityai/stable-diffusion-2-1-base"
dataset_name = "benlehrburger/modern-architecture"
model_save_name = "img2img-depth-finetuned-modern-model"
local_folder_name = "img2img-depth-finetuned-modern-model"
...
def train(
    ...
    image_pipe = StableDiffusionImg2ImgPipeline.from_pretrained(start_model);
